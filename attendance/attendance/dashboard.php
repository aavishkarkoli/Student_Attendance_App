...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
		<?php
			$query_subject = "SELECT subject.name, subject.id from subject INNER JOIN faculty_subject WHERE faculty_subject.id = subject.id AND faculty_subject.uid = {$_SESSION['uid']}  ORDER BY subject.name";
...
<div class="container mt-5"><div class="row"><div class="col-md-4"><?php include('pending_attendance.php'); ?></div>
<div class="col-md-4"><?php include('today_attendance.php'); ?></div>
<div class="col-md-4"><?php include('students_details.php'); ?></div>
</div></<div>
