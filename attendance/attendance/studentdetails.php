			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<tbody>
						<?php
							$outputData = '';
							$studentQuery = "SELECT DISTINCT name, rollno FROM `faculty_subject` INNER JOIN student_subject INNER JOIN student WHERE faculty_subject.id = student_subject.id AND student_subject.sid = student.sid AND faculty_subject.uid = $uid";
