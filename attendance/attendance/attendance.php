...
<div class="container" style="margin-top:20px;">
  <div class="row">
	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<form action="" method="get" class="form-inline mb-5" id="subjectForm" data-toggle="validator">
				<div class="form-group">
					<label for="select" class="control-label"> Subject: &nbsp;</label>
					<?php
											
						$query_subject = "SELECT subject.name, subject.id from subject 
INNER JOIN faculty_subject WHERE faculty_subject.id = subject.id AND faculty_subject.uid = {$_SESSION['uid']}  ORDER BY subject.name";
				...
				<input type="submit" class="btn btn-primary" name="sbt_stn" value="Load Student">&nbsp;
			</form>
